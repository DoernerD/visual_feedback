...
class WaypointFollowingController(object):
    ...
    def printStates(self, u):
        ...
        if self.limitOutputCounter % 20 == 1:
            ...
            print("Current States: {}".format(self.stateEstim))
            print("Reference States: {}".format(self.ref))
            print("Distance Error: {}, Heading Angle: {}, Depth Error: {}".format(self.distanceErr, self.headingAngle, self.err[2]))
            print("[thruster, vec (horizontal), vec (vertical), vbs, lcg]")
            print("Control Input raw: {}".format(u))
            print("Control Input: {}".format(self.uLimited))
            print("Anti Windup Int: {}".format(self.antiWindupDifferenceInt))
            print("")
